...
{
    /// <summary>
    /// Represents an abstract base class for middleware implementations that utilize three specific services.
    /// </summary>
    ...
    public abstract class Middleware<TService0, TService1, TService2> : IMiddleware<TService0, TService1, TService2>
    {
        private readonly RequestDelegate next;

        /// <summary>
        /// Initializes a new instance of the <see cref="Middleware{TService0, TService1, TService2}"/> class.
        /// </summary>
        ...
        protected abstract Task OnInvokeServiceAsync(HttpContext context, TService0 s0, TService1 s1, TService2 s2);
        ...
        /// <param name="s2">The third service to be used by the middleware.</param>
        /// <returns>A <see cref="Task"/> representing the asynchronous middleware operation.</returns>
        public async Task InvokeAsync(HttpContext context, TService0 s0, TService1 s1, TService2 s2)
        {
            await this.OnInvokeServiceAsync(context, s0, s1, s2);
