...
{
    /// <summary>
    /// Represents an abstract base class for middleware implementations that utilize four specific services.
    /// </summary>
    ...
    public abstract class Middleware<TService0, TService1, TService2, TService3>
        : IMiddleware<TService0, TService1, TService2, TService3>
    {
        private readonly RequestDelegate next;

        /// <summary>
        /// Initializes a new instance of the <see cref="Middleware{TService0, TService1, TService2, TService3}"/> class.
        /// </summary>
        ...
        protected abstract Task OnInvokeServiceAsync(HttpContext context, TService0 s0, TService1 s1, TService2 s2, TService3 s3);
        ...
        /// <param name="s3">The fourth service to be used by the middleware.</param>
        /// <returns>A <see cref="Task"/> representing the asynchronous middleware operation.</returns>
        public async Task InvokeAsync(HttpContext context, TService0 s0, TService1 s1, TService2 s2, TService3 s3)
        {
            await this.OnInvokeServiceAsync(context, s0, s1, s2, s3);
